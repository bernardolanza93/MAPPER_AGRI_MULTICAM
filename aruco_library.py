...
def aruco_detection(image1):
    ...
    if os.path.exists(os.path.join(FOLDER_CALIBRATION_CAMERA, "camera_matrix.npy")) and os.path.exists(
        ...
        Object of type cv::aruco::DetectorParameters. This object includes all parameters that can be customized during 
        ...
        if ids is not None:
            ...
            roll, pitch, yaw = cv2.RQDecomp3x3(R)
        ...
        print("CALIBRATION FILE NOT FOUND, RUN CALIBRATION BEFORE! ")
        return 0
