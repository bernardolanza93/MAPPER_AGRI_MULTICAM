...
if SAVE_VIDEO_TIME != 0:
    ...
    gst_out_depth = "appsrc ! video/x-raw, format=YUY2 ! queue ! videoconvert ! video/x-raw,format=BGRx ! nvvidconv ! nvv4l2h264enc ! h264parse ! matroskamux ! filesink location=DEPTH.mkv "
