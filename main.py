...
if SAVE_VIDEO_TIME != 0:
    ...
    try:
        ...
        gst_out_depth = "appsrc ! video/x-raw, format=GRAY16_LE ! queue ! videoconvert ! video/x-raw,format=GRAY16_LE ! nvvidconv ! nvv4l2h264enc ! h264parse ! matroskamux ! filesink location=DEPTH.mkv "
