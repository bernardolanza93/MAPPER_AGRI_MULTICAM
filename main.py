...
def RS_capture(queue,status):
    ...
    if SAVE_VIDEO_TIME != 0:
        if enable_D435i:
            gst_out = "appsrppppc ! video/x-raw, format=BGR ! queue ! videoconvert ! video/x-raw,format=BGRx ! nvvidconv ! nvv4l2h264enc ! h264parse ! matroskamux ! filesink location=RGB.mkv "
